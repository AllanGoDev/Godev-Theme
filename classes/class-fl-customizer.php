...
final class FLCustomizer
{
  ...
  static public function preview_init()
  {
    ...
    wp_enqueue_script('fl-stylesheet', FL_THEME_URL . '/assets/js/stylesheet.js', array(), '', true);
    wp_enqueue_script('fl-customizer-preview', FL_THEME_URL . '/assets/js/customizer-preview.js', array(), '', true);
  }
  ...
  {
    wp_enqueue_style('fl-customizer', FL_THEME_URL . '/assets/css/customizer.css', array(), FL_THEME_VERSION);
    wp_enqueue_script('fl-customizer-toggles', FL_THEME_URL . '/assets/js/customizer-toggles.js', array(), FL_THEME_VERSION, true);
    wp_enqueue_script('fl-customizer', FL_THEME_URL . '/assets/js/customizer.js', array(), FL_THEME_VERSION, true);
    wp_enqueue_script('ace', FL_THEME_URL . '/assets/js/ace/ace.js', array(), FL_THEME_VERSION, true);
    wp_enqueue_script('ace-language-tools', FL_THEME_URL . '/assets/js/ace/ext-language_tools.js', array(), FL_THEME_VERSION, true);
    if (true === apply_filters('fl_select2_enabled', true)) {
      wp_enqueue_style('select2', FL_THEME_URL . '/assets/css/select2.min.css', array(), FL_THEME_VERSION);
      wp_enqueue_script('select2', FL_THEME_URL . '/assets/js/select2.min.js', array('jquery'), FL_THEME_VERSION, true);
    }
  }
