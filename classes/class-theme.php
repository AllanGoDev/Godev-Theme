...
final class FLTheme
{
  ...
  {
    //Bootstrap
    wp_enqueue_style('bootstrap-rtl', FL_THEME_URL . '/assets/css/bootstrap.rtl.min.css');
    wp_enqueue_style('bootstrap', FL_THEME_URL . '/assets/css/bootstrap.min.css');
    wp_enqueue_script('bootstrap-bundle', FL_THEME_URL . '/assets/js/bootstrap.bundle.min.js', array('jquery'), '5.2', true);
    wp_enqueue_script('bootstrap', FL_THEME_URL . '/assets/js/bootstrap.min.js', array('jquery'), '5.2', true);
    wp_enqueue_script('bootstrap-popper', FL_THEME_URL . '/assets/js/popper.min.js', array('jquery'), '5.2', true);

    //Validação
    wp_enqueue_script('validacao-js', FL_THEME_URL . '/assets/js/validacao.js', array(), '', true);

    //Add Css do Tema 
    wp_enqueue_style('fl-child-theme', FL_THEME_URL . '/style.css');

    // Add Tradução MagnificPopup
    wp_enqueue_script('traducao-magnificpopup-js', FL_THEME_URL . '/assets/js/traducao.magnificpopup.js', array(), '', true);

    // Add Mask
    wp_enqueue_script('mask', FL_THEME_URL . '/assets/js/jquery.mask.min.js', array(), '', true);

    // Add Justify Gallery
    wp_enqueue_script('justifiedGallery', FL_THEME_URL . '/assets/js/jquery.justifiedGallery.min.js', array(), '', true);
    wp_enqueue_style('justifiedGallery-css', FL_THEME_URL . '/assets/css/justifiedGallery.min.css');

    //Add Mansory
    wp_enqueue_script('masonry-4-2-2', FL_THEME_URL . '/assets/js/masonry.pkgd.min.js', array(), '', true);
    wp_enqueue_script('imagesloaded-desandro', FL_THEME_URL . '/assets/js/imagesloaded.pkgd.min.js', array(), '', true);
    wp_enqueue_style('masonry-css', FL_THEME_URL . '/assets/css/masonry.css');

    //Add Swiper Slide
    wp_enqueue_script('swiper-js', FL_THEME_URL . '/assets/js/swiper-bundle.min.js', array(), '', true);
    wp_enqueue_style('swiper-css', FL_THEME_URL . '/assets/css/swiper-bundle.min.css');

    //Add BeefUp
    wp_enqueue_script('beefup-js', FL_THEME_URL . '/assets/js/jquery.beefup.min.js', array(), '', true);
    wp_enqueue_style('beefup-css', FL_THEME_URL . '/assets/css/jquery.beefup.css');

    //Css Site

    /*--------- Paginação -----------*/
    wp_enqueue_style('pagination-css', FL_THEME_URL . '/assets/css/pagination.css');

    /*--------- Swiper Padrão ------*/
    wp_enqueue_style('swiper-css-padrao', FL_THEME_URL . '/assets/css/swiper.css');

    /*---------- Menu -------------*/
    wp_enqueue_style('menu', FL_THEME_URL . '/assets/css/menu.css');

    /*---------- Rodapé -------------*/
    wp_enqueue_style('rodape', FL_THEME_URL . '/assets/css/rodape.css');
    ...
    // jQuery
    wp_enqueue_script('jquery-throttle', FL_THEME_URL . '/assets/js/jquery.throttle.min.js', array('jquery'), FL_THEME_VERSION, true);
    if ('fadein' !== self::get_setting('fl-fixed-header')) {
      global $wp_version;
      if (version_compare($wp_version, '4.6', '<')) {
        wp_register_script('imagesloaded', FL_THEME_URL . '/assets/js/jquery.imagesloaded.min.js', array('jquery'), FL_THEME_VERSION, true);
      }
    ...
    if (self::get_setting('fl-lightbox') === 'enabled') {
      wp_enqueue_style('jquery-magnificpopup', FL_THEME_URL . '/assets/css/jquery.magnificpopup.css', array(), FL_THEME_VERSION);
      wp_enqueue_script('jquery-magnificpopup', FL_THEME_URL . '/assets/js/jquery.magnificpopup.min.js', array(), FL_THEME_VERSION, true);
    }

    // FitVids
    $body_classes = get_body_class();
    if (!in_array('fl-builder', $body_classes, true)) {
      wp_enqueue_script('jquery-fitvids', FL_THEME_URL . '/assets/js/jquery.fitvids.js', array(), FL_THEME_VERSION, true);
    }
    ...
    if (FLCustomizer::is_preset_preview()) {
      wp_enqueue_script('fl-automator-preview', FL_THEME_URL . '/assets/js/preview.js', array(), FL_THEME_VERSION, true);
    ...
    // Core theme JS
    wp_enqueue_script('fl-automator', FL_THEME_URL . '/assets/js/theme' . (self::is_debug() ? '' : '.min') . '.js', array(), FL_THEME_VERSION, true);
    ...
    // RTL Support
    if (is_rtl()) {
      wp_enqueue_style('fl-automator-rtl', FL_THEME_URL . '/assets/css/rtl.css', array(), FL_THEME_VERSION);
    }
  }

  static public function rodape()
  {
  }

  static public function addRewriteRules($aRules)
  {
    $aNewRules = array(
      // 'blog/([^/]+)?$' => 'index.php?pagename=blog&categoria=$matches[1]',
      // 'blog/([^/]+)/page/([0-9]{1,})/?$' => 'index.php?pagename=blog&categoria=$matches[1]&paged=$matches[2]',
    );
    $aRules = $aNewRules + $aRules;
    return $aRules;
  }

  static public function addVariaveisPesquisa($query_vars)
  {
    $query_vars[] = 'search';
  ...
  static function customQueryVars($query)
  {
    if (!is_admin() && $query->is_main_query()) {
      // if (is_post_type_archive('agenda_escolar')) {
      // 	$query->set('posts_per_page', 16);
      // }
      // if (is_post_type_archive('info_drummond') || is_tax('cat_info_drummond')) {
      // 	$query->set('posts_per_page', 6);
      // }

      // if (is_post_type_archive('eventos') || is_tax('eventos')) {
      // 	$query->set('posts_per_page', 14);
      // }
      // 	if (is_post_type_archive('lives')) {
      // 		$query->set('posts_per_page', 12);
      // 	}
      // 	if (is_post_type_archive('material_contratante')) {
  ...
  static function activeLinkMenu($classes, $item)
  {
    if (in_array('current-menu-item', $classes)) {
      $classes[] = 'is-active-link';
    }
    return $classes;
  }
  ...
  static public function setup()
  {
    ...
    require_once FL_THEME_DIR . '/includes/default/customizer-functions.php';
    require_once FL_THEME_DIR . '/includes/default/customizer-panel-general.php';
    require_once FL_THEME_DIR . '/includes/default/customizer-panel-header.php';
    require_once FL_THEME_DIR . '/includes/default/customizer-panel-content.php';
    require_once FL_THEME_DIR . '/includes/default/customizer-panel-footer.php';
    require_once FL_THEME_DIR . '/includes/default/customizer-panel-widgets.php';
    require_once FL_THEME_DIR . '/includes/default/customizer-panel-code.php';
    require_once FL_THEME_DIR . '/includes/default/customizer-panel-settings.php';
    require_once FL_THEME_DIR . '/includes/default/customizer-presets.php';
  ...
  static public function top_bar_col1()
  {
    ...
    include locate_template('includes/default/top-bar-col1.php');
  }
  ...
  static public function top_bar_col2()
  {
    ...
    include locate_template('includes/default/top-bar-col2.php');
  }
  ...
  static public function top_bar()
  {
    ...
    if ('none' !== $top_bar_layout && $top_bar_enabled) {
      get_template_part('includes/default/top-bar');
    }
  }
  ...
  static public function fixed_header()
  {
    ...
    if ('fadein' === $header_layout && $header_enabled && 'vertical-left' !== $nav_layout && 'vertical-right' !== $nav_layout) {
      get_template_part('includes/default/fixed-header');
    }
  }
  ...
  static public function header_layout()
  {
    ...
    if ('none' !== $header_layout && $header_enabled) {
      get_template_part('includes/default/nav-' . $header_layout);
    }
  }
  ...
  static public function social_icons($circle = true)
  {
    ...
    FLTheme::enqueue_fontawesome();
    include locate_template('includes/default/social-icons.php');
  }
  ...
  static public function footer_widgets()
  {
    if (self::has_footer_widgets()) {
      get_template_part('includes/default/footer-widgets');
    }
  }
  ...
  static public function footer()
  {
    ...
    if ('none' !== $footer_layout) {
      get_template_part('includes/default/footer');
    }
  }
  ...
  static public function footer_col1()
  {
    ...
    include locate_template('includes/default/footer-col1.php');
  }
  ...
  static public function footer_col2()
  {
    ...
    include locate_template('includes/default/footer-col2.php');
  }
  ...
  static public function archive_page_header()
  {
    ...
    if (!empty($page_title)) {
      include locate_template('includes/default/archive-header.php');
    }
  }
  ...
  static public function post_top_meta()
  {
    ...
    include locate_template('includes/default/post-top-meta.php');
  }
  ...
  static public function post_bottom_meta()
  {
    ...
    include locate_template('includes/default/post-bottom-meta.php');
  }
  ...
  static public function display_comment($comment, $args, $depth)
  {
    ...
    include locate_template('includes/default/comment.php');
  }
