			...
			'options' => array(
				...
				'fl-framework'           => array(
					...
					'control' => array(
						...
						'type'        => 'select',
						'description' =>
						__('Select a CSS framework for the theme. Default is a bare minimal Bootstrap 4.', 'fl-automator'),
						'choices'     => array(
							'base'        => __('Minimal Bootstrap 4', 'fl-automator'),
							'base-5'      => __('Minimal Bootstrap 5', 'fl-automator'),
							'bootstrap'   => __('Full Bootstrap 4', 'fl-automator'),
							'bootstrap-5' => __('Full Bootstrap 5', 'fl-automator'),
						),
					),
				),
